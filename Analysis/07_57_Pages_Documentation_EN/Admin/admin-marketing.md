# PAGE DOCUMENT: COUPON GENERATION ENGINE
...
## 1. METADATA
- **Component**: Coupon Generation Engine
- **Physical Tree Path**: `src/app/(admin)/admin/marketing/page.tsx`
- **Browser Route**: `/admin/marketing`

---

## 2. CORE BUSINESS INTELLIGENCE
Imagine this functionality purely as: **The "Discount Factory". Generates promotion codes bounded by expiration dates and usage limits.**
...
- **Enforcement**: Coupon Generation Engine mandates pristine Security isolations.
- **Mechanics**: **Kiểm tra tỷ lệ rớt giá để hệ thống thanh toán tự bù trừ tiền thiếu, không thu khách.**. It boldly overrides basic Row Level Security boundaries selectively, since typical Supabase RLS natively blocks queries not directly owned by the active user.