# TÀI LIỆU TRANG: Giao Diện MYPAGE RECURRING NEW
...
## 1. THÔNG TIN CHUNG
- **Vị trí của file code**: `src/app/(user)/mypage/recurring-new/page.tsx`

---

## 2. TRANG NÀY SINH RA ĐỂ LÀM GÌ?
Đây là màn hình Mở rộng/Chức năng thứ yếu hỗ trợ mảnh ghép tổng quan của cổng thông tin phân quyền `user`.
