# TÀI LIỆU TRANG: BĂNG CHUYỀN THANH TOÁN (ADMIN-TRANSACTIONS)
...
## 1. THÔNG TIN CHUNG
- **Tên trang**: Băng Chuyền Thanh Toán
- **Vị trí của file code**: `src/app/(admin)/admin/transactions/page.tsx`
- **Đường link trên trình duyệt**: `[Tên-miền]/admin/transactions`

---

## 2. TRANG NÀY SINH RA ĐỂ LÀM GÌ?
Hãy tưởng tượng trang này là **Bảng sao kê in ra từ vòi ngân hàng. Khách quẹt thẻ gì, kẹt lúc mấy giờ đều phơi hết ở đây.**
...
- **Bảng `payments` kết dính dội sóng với API NicePay để kiểm tra đối soát rạch ròi.**
