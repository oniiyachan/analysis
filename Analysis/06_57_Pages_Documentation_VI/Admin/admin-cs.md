# TÀI LIỆU TRANG: TÒA ÁN GIẢI QUYẾT TRANH CHẤP (ADMIN-CS)
...
## 1. THÔNG TIN CHUNG
- **Tên trang**: Tòa Án Giải Quyết Tranh Chấp
- **Vị trí của file code**: `src/app/(admin)/admin/cs/page.tsx`
- **Đường link trên trình duyệt**: `[Tên-miền]/admin/cs`

---

## 2. TRANG NÀY SINH RA ĐỂ LÀM GÌ?
Hãy tưởng tượng trang này là **Như đồn công an. Nơi nhân viên chăm sóc khách hàng vào đây để đền tiền, bồi thường tã lót khi khách chửi thợ dọn nhà bẩn.**
...
- **Cho phép thay đổi trạng thái Refund (Hoàn tiền), móc thẳng API NicePay 2.0 để nhả tiền về STK.**
