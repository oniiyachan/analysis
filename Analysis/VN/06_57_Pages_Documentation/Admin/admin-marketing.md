# TÀI LIỆU TRANG: NHÀ MÁY IN MÃ GIẢM GIÁ (ADMIN-MARKETING)
...
## 1. THÔNG TIN CHUNG
- **Tên trang**: Nhà Máy In Mã Giảm Giá
- **Vị trí của file code**: `src/app/(admin)/admin/marketing/page.tsx`
- **Đường link trên trình duyệt**: `[Tên-miền]/admin/marketing`

---

## 2. TRANG NÀY SINH RA ĐỂ LÀM GÌ?
Hãy tưởng tượng trang này là **Máy in tiền. Cho phép Marketing tạo Coupon Code (giảm 10%, giảm 20k) và thiết lập ngày hết hạn.**
...
- **Kiểm tra tỷ lệ rớt giá để hệ thống thanh toán tự bù trừ tiền thiếu, không thu khách.**
