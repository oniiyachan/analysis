# TÀI LIỆU TRANG: BẢNG ĐIỀU KHIỂN TÀI CHÍNH (ADMIN-ANALYTICS)
...
## 1. THÔNG TIN CHUNG
- **Tên trang**: Bảng Điều Khiển Tài Chính
- **Vị trí của file code**: `src/app/(admin)/admin/analytics/page.tsx`
- **Đường link trên trình duyệt**: `[Tên-miền]/admin/analytics`

---

## 2. TRANG NÀY SINH RA ĐỂ LÀM GÌ?
Hãy tưởng tượng trang này là **Đây là cái "Radar Kiếm Tiền". Giúp sếp nhìn thấy hôm nay công ty đẻ ra bao nhiêu VND, rớt bao nhiêu khách dọc đường.**
...
- **Tính toán biểu đồ cực nặng, phải chọc thủng RLS để đứng trên vạn vật nhìn xuống.**
