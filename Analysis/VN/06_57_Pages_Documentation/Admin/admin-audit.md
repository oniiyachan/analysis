# TÀI LIỆU TRANG: CAMERA GIÁM SÁT LỊCH SỬ (ADMIN-AUDIT)
...
## 1. THÔNG TIN CHUNG
- **Tên trang**: Camera Giám Sát Lịch Sử
- **Vị trí của file code**: `src/app/(admin)/admin/audit/page.tsx`
- **Đường link trên trình duyệt**: `[Tên-miền]/admin/audit`

---

## 2. TRANG NÀY SINH RA ĐỂ LÀM GÌ?
Hãy tưởng tượng trang này là **Đây là cái "Camera an ninh". Bất cứ đứa nhân viên vận hành nào lén sửa giá, xóa đơn, hệ thống sẽ ghim vết tay lại ở đây không chối được.**
...
- **Bảng `audit_logs`. Chỉ được Đọc, Không được sửa xóa hòng phi tang.**
