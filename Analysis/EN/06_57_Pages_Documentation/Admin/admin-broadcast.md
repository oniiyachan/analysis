# PAGE DOCUMENT: BROADCAST & PUSH MESSAGING
...
## 1. METADATA
- **Component**: Broadcast & Push Messaging
- **Physical Tree Path**: `src/app/(admin)/admin/broadcast/page.tsx`
- **Browser Route**: `/admin/broadcast`

---

## 2. CORE BUSINESS INTELLIGENCE
Imagine this functionality purely as: **The "Loudspeaker". Allows marketing teams to blast scheduled promotional notifications to thousands of user devices.**
...
- **Enforcement**: Broadcast & Push Messaging mandates pristine Security isolations.
- **Mechanics**: **Kết nối chặt với hệ thống Solapi/Alimtalk và Firebase Cloud Messaging.**. It boldly overrides basic Row Level Security boundaries selectively, since typical Supabase RLS natively blocks queries not directly owned by the active user.